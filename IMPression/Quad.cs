...
namespace IMPression
{
    ...
    public struct Quad : IComparable<Quad>
    {
        ...
        public static double Log(Quad value)
        {
            ...
            return Math.Log(value.SignificandBits | highestBit, Constants.E) + value.Exponent * 0.69314718055994530941723212145818;
        }
        ...
        public static unsafe implicit operator double (Quad value)
        {
