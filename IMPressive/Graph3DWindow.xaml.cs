...
namespace IMPressive
{
    ...
    public partial class Graph3DWindow : Window
    {
        ...
        public Point3D[,] CreateDataArray(Func<Complex, Complex, double?> f)
        {
        ...
        private double? F(Complex x, Complex y)
        {
            try
            {
                ...
                ret = parser.Calculate(txtOperation.Text, new Var("x", x), new Var("y", y));
    ...
    public class SurfacePlotVisual3D : ModelVisual3D
    {
        ...
        private Model3D CreateModel()
        {
            ...
            {
                GeometryModel3D label = TextCreator.CreateTextLabelModel3D("Axe X", Brushes.Black, true, FontSize * 10,
            ...
            {
                GeometryModel3D label = TextCreator.CreateTextLabelModel3D("Axe Y", Brushes.Black, true, FontSize * 10,
            ...
            {
                GeometryModel3D label = TextCreator.CreateTextLabelModel3D("Axe Z", Brushes.Black, true, FontSize * 10,
